...
int main()
{
    ...
    float vertices[] = {
        // координаты         // цвета
         0.5f, -0.5f, 0.0f,  0.07f, 0.07f, 0.84f,  // нижняя правая вершина
        -0.5f, -0.5f, 0.0f,  0.92f, 0.07f, 0.15f,  // нижняя левая вершина
         0.0f,  0.5f, 0.0f,  0.46f, 0.20f, 0.63f   // верхняя вершина 
    };
